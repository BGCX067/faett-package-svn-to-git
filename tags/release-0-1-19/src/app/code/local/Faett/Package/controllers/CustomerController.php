...
/**
 * Faett_Package_CustomerController
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Package_CustomerController extends Mage_Core_Controller_Front_Action
{
    ...
    /**
     * Display package links bought by customer
     *
     */
    public function productsAction()
    {
        ...
        if ($block = $this->getLayout()->getBlock('package_customer_products_list')) {
