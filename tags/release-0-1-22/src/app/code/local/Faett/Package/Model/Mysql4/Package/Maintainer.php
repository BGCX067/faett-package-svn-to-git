...
/**
 * Faett_Package_Model_Mysql4_Package_Maintainer
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Package_Model_Mysql4_Package_Maintainer
    ...
    {
        // Note that the package_maintainer_id refers to the key field in our database table.
        $this->_init('package/package_maintainer', 'package_maintainer_id');
    }
}