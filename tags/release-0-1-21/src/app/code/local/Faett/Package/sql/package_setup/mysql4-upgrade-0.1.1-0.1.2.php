...
$installer->getConnection()->addColumn($installer->getTable('package/link_title'), 'version', "varchar(25) NOT NULL default '' AFTER `title`");
$installer->getConnection()->addColumn($installer->getTable('package/link_title'), 'stability', "varchar(25) NOT NULL default '' AFTER `version`");
