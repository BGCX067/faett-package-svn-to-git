...
/**
 * Faett_Package_Model_Mysql4_Customer_Collection
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Package_Model_Mysql4_Customer_Collection
     ...
     */
    public function addActiveToResult($productId)
    {
        $this->getSelect()
            ->joinLeft(array('default_active_table' => $this->getTable('package/package_maintainer')),
                '`default_active_table`.customer_id=`e`.entity_id AND `default_active_table`.product_id=' . $productId,
                array('active_maintainer' => 'active'));
