...
/**
 * Faett_Package_Model_System_Config_Source_Contentdisposition
 *
 * NOTICE OF LICENSE
 * 
...
/**
 * Package Content Disposition Source.
 *
 * @category   	Faett
 * @package    	Faett_Package
 * @copyright  	Copyright (c) 2009 <tw@faett.net> Tim Wagner
 ...
 */
class Faett_Package_Model_System_Config_Source_Contentdisposition
{
    public function toOptionArray()
    {
        return array(
            array(
                'value' => 'attachment',
                'label' => Mage::helper('package')->__('attachment')
            ),
            array(
                'value' => 'inline',
                'label' => Mage::helper('package')->__('inline')
            )
        );
    }
}
