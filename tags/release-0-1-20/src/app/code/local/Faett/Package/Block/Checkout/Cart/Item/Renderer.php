...
/**
 * Faett_Package_Block_Checkout_Cart_Item_Renderer
 *
 * NOTICE OF LICENSE
 * 
...
/**
 * Shopping cart package item render block.
 *
 * @category   	Faett
 * @package    	Faett_Package
 * @copyright  	Copyright (c) 2009 <tw@faett.net> Tim Wagner
 ...
 */
class Faett_Package_Block_Checkout_Cart_Item_Renderer
    ...
    {
        $itemLinks = array();
        if ($linkIds = $this->getItem()->getOptionByCode('package_link_ids')) {
